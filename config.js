...
module.exports = {
  //==========================================- MAIN - CONFIGS -==================================================================
  SESSION_ID: process.env.SESSION_ID || "BHASHI-MD~fVZCBLrJ#96XO228WvgBGlkUDiHFT3Ay0X6kEx_WNQvnLNNXf9CM",
  // ADD Your Session Id 
  ...
  packname: process.env.packname || "🪄ANJANA",
  author: process.env.author || "🍂🖤𝗞𝗜𝗡𝗚 𝗔𝗡𝗝𝗔𝗡𝗔 𝗕𝗕𝗛 💦🥵🍂",
  //==========================================- API-CONFIGS -==========================================================
